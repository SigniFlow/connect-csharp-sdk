...
${nuget_cmd} install src/SigniFlow.Connect/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/SigniFlow.Connect.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/SigniFlow.Connect.dll \
-recurse:'src/SigniFlow.Connect/*.cs' \
-doc:bin/SigniFlow.Connect.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/SigniFlow.Connect.dll was created successfully"
fi
