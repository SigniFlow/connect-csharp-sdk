...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class CreateWorkflowRequest :  IEquatable<CreateWorkflowRequest>, IValidatableObject
    {
        ...
        /// <param name="messageField">Custom message to display to participants (required).</param>
        ...
        public CreateWorkflowRequest(string additionalDataField = default(string), AutoExpire autoExpireField = default(AutoExpire), AutoRemind autoRemindField = default(AutoRemind), string docField = default(string), string docNameField = default(string), DateTime dueDateField = default(DateTime), DocExtension extensionField = default(DocExtension), string messageField = default(string), Priority priorityField = default(Priority), int sLAField = 0, TokenField tokenField = default(TokenField))
        {
            ...
            {
                throw new InvalidDataException("additionalDataField is a required property for CreateWorkflowRequest and cannot be null");
            }
            else
            {
            ...
            // to ensure "autoExpireField" is required (not null)
            if (autoExpireField == null)
            {
                throw new InvalidDataException("autoExpireField is a required property for CreateWorkflowRequest and cannot be null");
            }
            else
            {
            ...
            // to ensure "messageField" is required (not null)
            if (messageField == null)
            {
                throw new InvalidDataException("messageField is a required property for CreateWorkflowRequest and cannot be null");
            }
            else
            {
            ...
            if (sLAField == null)
            {
                throw new InvalidDataException("sLAField is a required property for CreateWorkflowRequest and cannot be null");
            }
            else
            {
