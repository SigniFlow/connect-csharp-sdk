...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetDocumentTagFieldBoxPositionResponseDocumentTagFieldsBoxPositionField :  IEquatable<GetDocumentTagFieldBoxPositionResponseDocumentTagFieldsBoxPositionField>, IValidatableObject
    {
        ...
        public GetDocumentTagFieldBoxPositionResponseDocumentTagFieldsBoxPositionField(string heightField = default(string), decimal pageNumberField = default(decimal), string widthField = default(string), string xCoordinateField = default(string), string yCoordinateField = default(string))
        {
            ...
            if (heightField == null)
            {
                throw new InvalidDataException("heightField is a required property for GetDocumentTagFieldBoxPositionResponseDocumentTagFieldsBoxPositionField and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("pageNumberField is a required property for GetDocumentTagFieldBoxPositionResponseDocumentTagFieldsBoxPositionField and cannot be null");
            }
            else
            {
            ...
            if (widthField == null)
            {
                throw new InvalidDataException("widthField is a required property for GetDocumentTagFieldBoxPositionResponseDocumentTagFieldsBoxPositionField and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("xCoordinateField is a required property for GetDocumentTagFieldBoxPositionResponseDocumentTagFieldsBoxPositionField and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("yCoordinateField is a required property for GetDocumentTagFieldBoxPositionResponseDocumentTagFieldsBoxPositionField and cannot be null");
            }
            else
            {
