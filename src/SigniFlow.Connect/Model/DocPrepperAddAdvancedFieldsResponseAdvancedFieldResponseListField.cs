...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class DocPrepperAddAdvancedFieldsResponseAdvancedFieldResponseListField :  IEquatable<DocPrepperAddAdvancedFieldsResponseAdvancedFieldResponseListField>, IValidatableObject
    {
        ...
        public DocPrepperAddAdvancedFieldsResponseAdvancedFieldResponseListField(decimal docFieldIDField = default(decimal), string resultField = default(string))
        {
            ...
            {
                throw new InvalidDataException("docFieldIDField is a required property for DocPrepperAddAdvancedFieldsResponseAdvancedFieldResponseListField and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for DocPrepperAddAdvancedFieldsResponseAdvancedFieldResponseListField and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="DocFieldIDField", EmitDefaultValue=true)]        public decimal DocFieldIDField { get; set; }
