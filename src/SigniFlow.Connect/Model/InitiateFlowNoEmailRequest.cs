...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class InitiateFlowNoEmailRequest :  IEquatable<InitiateFlowNoEmailRequest>, IValidatableObject
    {
        ...
        public InitiateFlowNoEmailRequest(string docIDField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for InitiateFlowNoEmailRequest and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for InitiateFlowNoEmailRequest and cannot be null");
            }
            else
            {
