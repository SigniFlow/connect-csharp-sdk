...
namespace SigniFlow.Connect.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InitiateFlow_No_EmailRequest")]
    public partial class InitiateFlowNoEmailRequest : IEquatable<InitiateFlowNoEmailRequest>, IValidatableObject
    {
//    
//    
//        /// <summary>
//        /// Initializes a new instance of the <see cref="InitiateFlowNoEmailRequest" /> class.
//        /// </summary>
//        [JsonConstructorAttribute]
//        
//        protected InitiateFlowNoEmailRequest() { }
//        
//        
//    
//    
        ...
        public InitiateFlowNoEmailRequest(string docIDField = default(string), TokenField tokenField = default(TokenField))
        {
            // to ensure "docIDField" is required (not null)
            this.DocIDField = docIDField ?? throw new ArgumentNullException("docIDField is a required property for InitiateFlowNoEmailRequest and cannot be null");
            // to ensure "tokenField" is required (not null)
            this.TokenField = tokenField ?? throw new ArgumentNullException("tokenField is a required property for InitiateFlowNoEmailRequest and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InitiateFlowNoEmailRequest {\n");
        ...
        {
            return this.Equals(input as InitiateFlowNoEmailRequest);
        }

        /// <summary>
        /// Returns true if InitiateFlowNoEmailRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InitiateFlowNoEmailRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InitiateFlowNoEmailRequest input)
        {
            if (input == null)
                return false;
