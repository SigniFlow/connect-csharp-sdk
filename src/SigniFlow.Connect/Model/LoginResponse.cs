...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class LoginResponse :  IEquatable<LoginResponse>, IValidatableObject
    {
        ...
        public LoginResponse(string resultField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for LoginResponse and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for LoginResponse and cannot be null");
            }
            else
            {
