...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class SigningCeremonyV2RequestCheckboxFieldsListField :  IEquatable<SigningCeremonyV2RequestCheckboxFieldsListField>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="checkboxHField">Checkbox field height..</param>
        /// <param name="checkboxPageField">The page on which the Checkbox field is located..</param>
        /// <param name="checkboxWField">Checkbox field width..</param>
        /// <param name="checkboxXField">Checkbox field x-coordinates..</param>
        /// <param name="checkboxYField">Checkbox field y-coordinates..</param>
        /// <param name="isCheckedField">Is the checkbox field checked..</param>
        ...
        [DataMember(Name="CheckboxHField", EmitDefaultValue=false)]        public decimal CheckboxHField { get; set; }

        /// <summary>
        /// The page on which the Checkbox field is located.
        /// </summary>
        /// <value>The page on which the Checkbox field is located.</value>
        [DataMember(Name="CheckboxPageField", EmitDefaultValue=false)]        public decimal CheckboxPageField { get; set; }

        /// <summary>
        /// Checkbox field width.
        /// </summary>
        /// <value>Checkbox field width.</value>
        [DataMember(Name="CheckboxWField", EmitDefaultValue=false)]        public decimal CheckboxWField { get; set; }

        /// <summary>
        /// Checkbox field x-coordinates.
        /// </summary>
        /// <value>Checkbox field x-coordinates.</value>
        [DataMember(Name="CheckboxXField", EmitDefaultValue=false)]        public decimal CheckboxXField { get; set; }

        /// <summary>
        /// Checkbox field y-coordinates.
        /// </summary>
        /// <value>Checkbox field y-coordinates.</value>
        [DataMember(Name="CheckboxYField", EmitDefaultValue=false)]        public decimal CheckboxYField { get; set; }

        /// <summary>
        /// Is the checkbox field checked.
        /// </summary>
        /// <value>Is the checkbox field checked.</value>
        [DataMember(Name="IsCheckedField", EmitDefaultValue=false)]        public bool IsCheckedField { get; set; }
