...
//    
        ...
        public GetDocumentPrepperLinkRequest(string docIDField = default(string), decimal emailSettingField = default(decimal), string returnURLField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            this.DocIDField = docIDField ?? throw new ArgumentNullException("docIDField is a required property for GetDocumentPrepperLinkRequest and cannot be null");
            // to ensure "returnURLField" is required (not null)
            this.ReturnURLField = returnURLField ?? throw new ArgumentNullException("returnURLField is a required property for GetDocumentPrepperLinkRequest and cannot be null");
            // to ensure "tokenField" is required (not null)
            this.TokenField = tokenField ?? throw new ArgumentNullException("tokenField is a required property for GetDocumentPrepperLinkRequest and cannot be null");
