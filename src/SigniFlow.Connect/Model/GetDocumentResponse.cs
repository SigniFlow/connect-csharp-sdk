...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetDocumentResponse :  IEquatable<GetDocumentResponse>, IValidatableObject
    {
        ...
        public GetDocumentResponse(string docField = default(string), string docNameField = default(string), string extensionField = default(string), string resultField = default(string))
        {
            ...
            if (docField == null)
            {
                throw new InvalidDataException("docField is a required property for GetDocumentResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("docNameField is a required property for GetDocumentResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("extensionField is a required property for GetDocumentResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for GetDocumentResponse and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="ExtensionField", EmitDefaultValue=true)]        public string ExtensionField { get; set; }
