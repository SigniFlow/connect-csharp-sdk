...
namespace SigniFlow.Connect.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDocLinkRequest")]
...
//    
        ...
        public GetDocLinkRequest(string docIDField = default(string), string emailField = default(string), string returnURLField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            this.DocIDField = docIDField ?? throw new ArgumentNullException("docIDField is a required property for GetDocLinkRequest and cannot be null");
            // to ensure "emailField" is required (not null)
            this.EmailField = emailField ?? throw new ArgumentNullException("emailField is a required property for GetDocLinkRequest and cannot be null");
            // to ensure "returnURLField" is required (not null)
            this.ReturnURLField = returnURLField ?? throw new ArgumentNullException("returnURLField is a required property for GetDocLinkRequest and cannot be null");
            // to ensure "tokenField" is required (not null)
            this.TokenField = tokenField ?? throw new ArgumentNullException("tokenField is a required property for GetDocLinkRequest and cannot be null");
        }
