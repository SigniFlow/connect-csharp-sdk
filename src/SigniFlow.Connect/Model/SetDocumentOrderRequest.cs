...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class SetDocumentOrderRequest :  IEquatable<SetDocumentOrderRequest>, IValidatableObject
    {
        ...
        public SetDocumentOrderRequest(string docIDField = default(string), string documentOrderField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for SetDocumentOrderRequest and cannot be null");
            }
            else
            {
            ...
            if (documentOrderField == null)
            {
                throw new InvalidDataException("documentOrderField is a required property for SetDocumentOrderRequest and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for SetDocumentOrderRequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="DocumentOrderField", EmitDefaultValue=true)]        public string DocumentOrderField { get; set; }
