...
//    
        ...
        public WorkflowSignRequest(string docIDField = default(string), string latitudeField = default(string), string loginPasswordField = default(string), string loginUserNameField = default(string), string longitudeField = default(string), string signReasonField = default(string), decimal timeZoneOffsetField = default(decimal), TokenField tokenField = default(TokenField))
        {
            ...
            this.LatitudeField = latitudeField ?? throw new ArgumentNullException("latitudeField is a required property for WorkflowSignRequest and cannot be null");
            ...
            this.LongitudeField = longitudeField ?? throw new ArgumentNullException("longitudeField is a required property for WorkflowSignRequest and cannot be null");
            // to ensure "signReasonField" is required (not null)
            this.SignReasonField = signReasonField ?? throw new ArgumentNullException("signReasonField is a required property for WorkflowSignRequest and cannot be null");
