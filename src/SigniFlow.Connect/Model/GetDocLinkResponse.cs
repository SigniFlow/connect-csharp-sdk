...
namespace SigniFlow.Connect.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDocLinkResponse")]
...
//    
        ...
        public GetDocLinkResponse(string result = default(string), string url = default(string))
        {
            ...
            this.Result = result ?? throw new ArgumentNullException("result is a required property for GetDocLinkResponse and cannot be null");
            // to ensure "url" is required (not null)
            this.Url = url ?? throw new ArgumentNullException("url is a required property for GetDocLinkResponse and cannot be null");
        }
