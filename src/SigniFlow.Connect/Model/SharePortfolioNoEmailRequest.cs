...
//    
        ...
        public SharePortfolioNoEmailRequest(AccessLevelField accessLevelField = default(AccessLevelField), string portfolioIDField = default(string), ShareOptionField shareOptionField = default(ShareOptionField), TokenField tokenField = default(TokenField), string uniqueIDField = default(string))
        {
