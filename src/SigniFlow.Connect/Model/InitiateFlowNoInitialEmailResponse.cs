...
namespace SigniFlow.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InitiateFlowNoInitialEmailResponse :  IEquatable<InitiateFlowNoInitialEmailResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateFlowNoInitialEmailResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InitiateFlowNoInitialEmailResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateFlowNoInitialEmailResponse" /> class.
        /// </summary>
        ...
        public InitiateFlowNoInitialEmailResponse(decimal docIDField = default(decimal), string resultField = default(string))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for InitiateFlowNoInitialEmailResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for InitiateFlowNoInitialEmailResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InitiateFlowNoInitialEmailResponse {\n");
        ...
        {
            return this.Equals(input as InitiateFlowNoInitialEmailResponse);
        }

        /// <summary>
        /// Returns true if InitiateFlowNoInitialEmailResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InitiateFlowNoInitialEmailResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InitiateFlowNoInitialEmailResponse input)
        {
            if (input == null)
                return false;
