...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class LoginRequest :  IEquatable<LoginRequest>, IValidatableObject
    {
        ...
        [DataMember(Name="UserNameField", EmitDefaultValue=true)]        public string UserNameField { get; set; }

        /// <summary>
        /// SigniFlow user password
        /// </summary>
        /// <value>SigniFlow user password</value>
        [DataMember(Name="PasswordField", EmitDefaultValue=true)]        public string PasswordField { get; set; }
