...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class CreatePortfolioRequest :  IEquatable<CreatePortfolioRequest>, IValidatableObject
    {
        ...
        public CreatePortfolioRequest(decimal docIDField = default(decimal), string portfolioNameField = default(string), TokenField tokenIDField = default(TokenField))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for CreatePortfolioRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioNameField is a required property for CreatePortfolioRequest and cannot be null");
            }
            else
            {
            ...
            if (tokenIDField == null)
            {
                throw new InvalidDataException("tokenIDField is a required property for CreatePortfolioRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="TokenIDField", EmitDefaultValue=true)]        public TokenField TokenIDField { get; set; }
