...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class FullWorkflowRequestGroupStepField :  IEquatable<FullWorkflowRequestGroupStepField>, IValidatableObject
    {
        ...
        public FullWorkflowRequestGroupStepField(List<FullWorkflowRequestGroupStepFieldGroupMembersField> groupMembersField = default(List<FullWorkflowRequestGroupStepFieldGroupMembersField>), string groupNameField = default(string), decimal requiredNumberOfSignaturesField = default(decimal))
        {
            ...
            {
                throw new InvalidDataException("groupMembersField is a required property for FullWorkflowRequestGroupStepField and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("groupNameField is a required property for FullWorkflowRequestGroupStepField and cannot be null");
            }
            else
            {
            ...
            // to ensure "requiredNumberOfSignaturesField" is required (not null)
            if (requiredNumberOfSignaturesField == null)
            {
                throw new InvalidDataException("requiredNumberOfSignaturesField is a required property for FullWorkflowRequestGroupStepField and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="GroupMembersField", EmitDefaultValue=true)]        public List<FullWorkflowRequestGroupStepFieldGroupMembersField> GroupMembersField { get; set; }

        /// <summary>
        /// Group name.
        /// </summary>
        /// <value>Group name.</value>
        [DataMember(Name="GroupNameField", EmitDefaultValue=true)]        public string GroupNameField { get; set; }

        /// <summary>
        /// Required number of signatures in the group.
        /// </summary>
        /// <value>Required number of signatures in the group.</value>
        [DataMember(Name="RequiredNumberOfSignaturesField", EmitDefaultValue=true)]        public decimal RequiredNumberOfSignaturesField { get; set; }
        ...
        public bool Equals(FullWorkflowRequestGroupStepField input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.RequiredNumberOfSignaturesField != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RequiredNumberOfSignaturesField != null)
