...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetPrepperTemplateListResponseTemplateInformationValuesField :  IEquatable<GetPrepperTemplateListResponseTemplateInformationValuesField>, IValidatableObject
    {
        ...
        public GetPrepperTemplateListResponseTemplateInformationValuesField(string nameField = default(string), decimal prepperTemplateIDField = default(decimal), string templateDescriptionField = default(string))
        {
            ...
            if (nameField == null)
            {
                throw new InvalidDataException("nameField is a required property for GetPrepperTemplateListResponseTemplateInformationValuesField and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("prepperTemplateIDField is a required property for GetPrepperTemplateListResponseTemplateInformationValuesField and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("templateDescriptionField is a required property for GetPrepperTemplateListResponseTemplateInformationValuesField and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="TemplateDescriptionField", EmitDefaultValue=true)]        public string TemplateDescriptionField { get; set; }
