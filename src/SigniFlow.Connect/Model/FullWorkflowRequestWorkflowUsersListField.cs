...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class FullWorkflowRequestWorkflowUsersListField :  IEquatable<FullWorkflowRequestWorkflowUsersListField>, IValidatableObject
    {
        ...
        public FullWorkflowRequestWorkflowUsersListField(ActionField actionField = default(ActionField), ProxyAllowedField allowProxyField = default(ProxyAllowedField), bool autoSignField = default(bool), string emailAddressField = default(string), FullWorkflowRequestGroupStepField groupStepField = default(FullWorkflowRequestGroupStepField), string languageCodeField = default(string), string latitudeField = default(string), string longitudeField = default(string), string mobileNumberField = default(string), List<Object> preloadedFaceToFaceSignersField = default(List<Object>), string signReasonField = default(string), string signerPasswordField = default(string), string userFirstNameField = default(string), string userFullNameField = default(string), string userLastNameField = default(string), List<FullWorkflowRequestWorkflowUserFieldsField> workflowUserFieldsField = default(List<FullWorkflowRequestWorkflowUserFieldsField>))
        {
            ...
            if (workflowUserFieldsField == null)
            {
                throw new InvalidDataException("workflowUserFieldsField is a required property for FullWorkflowRequestWorkflowUsersListField and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="AutoSignField", EmitDefaultValue=true)]        public bool AutoSignField { get; set; }

        /// <summary>
        /// Workflow user&#39;s email addresses.
        /// </summary>
        /// <value>Workflow user&#39;s email addresses.</value>
        [DataMember(Name="EmailAddressField", EmitDefaultValue=true)]        public string EmailAddressField { get; set; }

        /// <summary>
        /// Gets or Sets GroupStepField
        /// </summary>
        [DataMember(Name="GroupStepField", EmitDefaultValue=true)]        public FullWorkflowRequestGroupStepField GroupStepField { get; set; }
        ...
        [DataMember(Name="LatitudeField", EmitDefaultValue=true)]        public string LatitudeField { get; set; }
        ...
        [DataMember(Name="LongitudeField", EmitDefaultValue=true)]        public string LongitudeField { get; set; }

        /// <summary>
        /// Group user&#39;s mobile number.
        /// </summary>
        /// <value>Group user&#39;s mobile number.</value>
        [DataMember(Name="MobileNumberField", EmitDefaultValue=true)]        public string MobileNumberField { get; set; }
        ...
        [DataMember(Name="PreloadedFaceToFaceSignersField", EmitDefaultValue=true)]        public List<Object> PreloadedFaceToFaceSignersField { get; set; }

        /// <summary>
        /// Reason for signature.
        /// </summary>
        /// <value>Reason for signature.</value>
        [DataMember(Name="SignReasonField", EmitDefaultValue=true)]        public string SignReasonField { get; set; }

        /// <summary>
        /// Face to face user&#39;s password.
        /// </summary>
        /// <value>Face to face user&#39;s password.</value>
        [DataMember(Name="SignerPasswordField", EmitDefaultValue=true)]        public string SignerPasswordField { get; set; }

        /// <summary>
        /// Face to face user&#39;s first name.
        /// </summary>
        /// <value>Face to face user&#39;s first name.</value>
        [DataMember(Name="UserFirstNameField", EmitDefaultValue=true)]        public string UserFirstNameField { get; set; }
        ...
        [DataMember(Name="UserLastNameField", EmitDefaultValue=true)]        public string UserLastNameField { get; set; }

        /// <summary>
        /// The list of the workflowed documents field.
        /// </summary>
        /// <value>The list of the workflowed documents field.</value>
        [DataMember(Name="WorkflowUserFieldsField", EmitDefaultValue=true)]        public List<FullWorkflowRequestWorkflowUserFieldsField> WorkflowUserFieldsField { get; set; }
