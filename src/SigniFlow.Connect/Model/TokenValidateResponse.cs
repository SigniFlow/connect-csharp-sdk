...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class TokenValidateResponse : IEquatable<TokenValidateResponse>, IValidatableObject
    {
        ...
        public TokenValidateResponse(string resultField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            this.ResultField = resultField ?? throw new ArgumentNullException("resultField is a required property for TokenValidateResponse and cannot be null");
            // to ensure "tokenField" is required (not null)
            this.TokenField = tokenField ?? throw new ArgumentNullException("tokenField is a required property for TokenValidateResponse and cannot be null");
        }
