...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class SharePortfolioNoEmailResponse :  IEquatable<SharePortfolioNoEmailResponse>, IValidatableObject
    {
        ...
        public SharePortfolioNoEmailResponse(string resultField = default(string))
        {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for SharePortfolioNoEmailResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SharePortfolioNoEmailResponse {\n");
        ...
        {
            return this.Equals(input as SharePortfolioNoEmailResponse);
        }

        /// <summary>
        /// Returns true if SharePortfolioNoEmailResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SharePortfolioNoEmailResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SharePortfolioNoEmailResponse input)
        {
            if (input == null)
                return false;
