...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetDocumentTagFieldPositionRequest :  IEquatable<GetDocumentTagFieldPositionRequest>, IValidatableObject
    {
        ...
        public GetDocumentTagFieldPositionRequest(decimal docIDField = default(decimal), string tagNameField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for GetDocumentTagFieldPositionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("tagNameField is a required property for GetDocumentTagFieldPositionRequest and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for GetDocumentTagFieldPositionRequest and cannot be null");
            }
            else
            {
