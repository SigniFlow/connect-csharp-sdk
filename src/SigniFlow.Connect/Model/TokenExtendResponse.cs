...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class TokenExtendResponse :  IEquatable<TokenExtendResponse>, IValidatableObject
    {
        ...
        public TokenExtendResponse(string resultField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for TokenExtendResponse and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for TokenExtendResponse and cannot be null");
            }
            else
            {
