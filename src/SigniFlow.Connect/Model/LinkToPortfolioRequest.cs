...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class LinkToPortfolioRequest :  IEquatable<LinkToPortfolioRequest>, IValidatableObject
    {
        ...
        /// <param name="documentNameField">Document name..</param>
        ...
        public LinkToPortfolioRequest(string docIDField = default(string), string documentNameField = default(string), string portfolioIDField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for LinkToPortfolioRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioIDField is a required property for LinkToPortfolioRequest and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for LinkToPortfolioRequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="DocumentNameField", EmitDefaultValue=false)]        public string DocumentNameField { get; set; }
