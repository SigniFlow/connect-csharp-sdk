...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class LinkToPortfolioResponse :  IEquatable<LinkToPortfolioResponse>, IValidatableObject
    {
        ...
        public LinkToPortfolioResponse(string portfolioIDField = default(string), string resultField = default(string))
        {
            ...
            {
                throw new InvalidDataException("portfolioIDField is a required property for LinkToPortfolioResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for LinkToPortfolioResponse and cannot be null");
            }
            else
            {
