...
namespace SigniFlow.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InitiateFlowResponse :  IEquatable<InitiateFlowResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateFlowResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InitiateFlowResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateFlowResponse" /> class.
        /// </summary>
        ...
        public InitiateFlowResponse(decimal docIDField = default(decimal), string resultField = default(string))
        {
            // to ensure "docIDField" is required (not null)
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for InitiateFlowResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for InitiateFlowResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as InitiateFlowResponse);
        }

        /// <summary>
        /// Returns true if InitiateFlowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InitiateFlowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InitiateFlowResponse input)
        {
            if (input == null)
                return false;
