...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetDocumentTagFieldPositionResponse :  IEquatable<GetDocumentTagFieldPositionResponse>, IValidatableObject
    {
        ...
        public GetDocumentTagFieldPositionResponse(List<GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField> documentTagFieldsPositionField = default(List<GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField>), string resultField = default(string))
        {
            ...
            if (documentTagFieldsPositionField == null)
            {
                throw new InvalidDataException("documentTagFieldsPositionField is a required property for GetDocumentTagFieldPositionResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for GetDocumentTagFieldPositionResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="DocumentTagFieldsPositionField", EmitDefaultValue=true)]        public List<GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField> DocumentTagFieldsPositionField { get; set; }
