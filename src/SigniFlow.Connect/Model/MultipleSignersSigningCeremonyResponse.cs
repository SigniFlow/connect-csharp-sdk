...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class MultipleSignersSigningCeremonyResponse :  IEquatable<MultipleSignersSigningCeremonyResponse>, IValidatableObject
    {
        ...
        {
            // to ensure "ceremonyIDField" is required (not null)
            if (ceremonyIDField == null)
            {
                throw new InvalidDataException("ceremonyIDField is a required property for MultipleSignersSigningCeremonyResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for MultipleSignersSigningCeremonyResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("signedDocumentField is a required property for MultipleSignersSigningCeremonyResponse and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="CeremonyIDField", EmitDefaultValue=true)]        public decimal CeremonyIDField { get; set; }
        ...
        [DataMember(Name="SignedDocumentField", EmitDefaultValue=true)]        public string SignedDocumentField { get; set; }
