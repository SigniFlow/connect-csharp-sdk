...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField :  IEquatable<GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField>, IValidatableObject
    {
        ...
        public GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField(decimal pageNumberField = default(decimal), string xCoordinateField = default(string), string yCoordinateField = default(string))
        {
            ...
            {
                throw new InvalidDataException("pageNumberField is a required property for GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("xCoordinateField is a required property for GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("yCoordinateField is a required property for GetDocumentTagFieldPositionResponseDocumentTagFieldsPositionField and cannot be null");
            }
            else
            {
