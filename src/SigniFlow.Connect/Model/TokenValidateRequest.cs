...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class TokenValidateRequest :  IEquatable<TokenValidateRequest>, IValidatableObject
    {
        ...
        public TokenValidateRequest(string _0 = default(string))
        {
            ...
            if (_0 == null)
            {
                throw new InvalidDataException("_0 is a required property for TokenValidateRequest and cannot be null");
            }
            else
            {
                this._0 = _0;
        ...
        /// Gets or Sets _0
        /// </summary>
        [DataMember(Name="0", EmitDefaultValue=true)]        public string _0 { get; set; }
