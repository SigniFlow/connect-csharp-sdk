...
namespace SigniFlow.Connect.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SigningCeremonyV2Request_TextFieldsListField")]
...
//        
//        protected SigningCeremonyV2RequestTextFieldsListField() { }
//        
//        
//    
//    
        ...
        /// Initializes a new instance of the <see cref="SigningCeremonyV2RequestTextFieldsListField" /> class.
        /// </summary>
        /// <param name="textFieldHField">Text field height. (required).</param>
        /// <param name="textFieldPageField">The page on which the text field is. (required).</param>
        /// <param name="textFieldValueField">The value of the text field. (required).</param>
        /// <param name="textFieldWField">Text field width. (required).</param>
        /// <param name="textFieldXField">Text field x-coordinates. (required).</param>
        /// <param name="textFieldYField">Text field y-coordinates. (required).</param>
        public SigningCeremonyV2RequestTextFieldsListField(decimal textFieldHField = default(decimal), decimal textFieldPageField = default(decimal), string textFieldValueField = default(string), decimal textFieldWField = default(decimal), decimal textFieldXField = default(decimal), decimal textFieldYField = default(decimal))
        {
            ...
            // to ensure "textFieldValueField" is required (not null)
            this.TextFieldValueField = textFieldValueField ?? throw new ArgumentNullException("textFieldValueField is a required property for SigningCeremonyV2RequestTextFieldsListField and cannot be null");
        ...
        [DataMember(Name = "TextFieldHField", IsRequired = true, EmitDefaultValue = true)]
        public decimal TextFieldHField { get; set; }

        /// <summary>
        /// The page on which the text field is.
        /// </summary>
        /// <value>The page on which the text field is.</value>
        [DataMember(Name = "TextFieldPageField", IsRequired = true, EmitDefaultValue = true)]
        public decimal TextFieldPageField { get; set; }

        /// <summary>
        /// The value of the text field.
        /// </summary>
        /// <value>The value of the text field.</value>
        [DataMember(Name = "TextFieldValueField", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "TextFieldWField", IsRequired = true, EmitDefaultValue = true)]
        public decimal TextFieldWField { get; set; }

        /// <summary>
        /// Text field x-coordinates.
        /// </summary>
        /// <value>Text field x-coordinates.</value>
        [DataMember(Name = "TextFieldXField", IsRequired = true, EmitDefaultValue = true)]
        public decimal TextFieldXField { get; set; }

        /// <summary>
        /// Text field y-coordinates.
        /// </summary>
        /// <value>Text field y-coordinates.</value>
        [DataMember(Name = "TextFieldYField", IsRequired = true, EmitDefaultValue = true)]
        public decimal TextFieldYField { get; set; }
