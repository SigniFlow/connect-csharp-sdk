...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class DownloadPortfolioResponse :  IEquatable<DownloadPortfolioResponse>, IValidatableObject
    {
        ...
        public DownloadPortfolioResponse(string portfolioDataField = default(string), decimal portfolioIDField = default(decimal), string portfolioNameField = default(string), string resultField = default(string))
        {
            ...
            if (portfolioDataField == null)
            {
                throw new InvalidDataException("portfolioDataField is a required property for DownloadPortfolioResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioIDField is a required property for DownloadPortfolioResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("portfolioNameField is a required property for DownloadPortfolioResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for DownloadPortfolioResponse and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="PortfolioDataField", EmitDefaultValue=true)]        public string PortfolioDataField { get; set; }
        ...
        [DataMember(Name="PortfolioNameField", EmitDefaultValue=true)]        public string PortfolioNameField { get; set; }
