...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class LogoutResponse : IEquatable<LogoutResponse>, IValidatableObject
    {
        ...
        public LogoutResponse(string resultField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            this.ResultField = resultField ?? throw new ArgumentNullException("resultField is a required property for LogoutResponse and cannot be null");
            // to ensure "tokenField" is required (not null)
            this.TokenField = tokenField ?? throw new ArgumentNullException("tokenField is a required property for LogoutResponse and cannot be null");
        }
