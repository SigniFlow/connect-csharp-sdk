...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class CreatePortfolioResponse :  IEquatable<CreatePortfolioResponse>, IValidatableObject
    {
        ...
        public CreatePortfolioResponse(decimal portfolioIDField = default(decimal), string resultField = default(string))
        {
            ...
            {
                throw new InvalidDataException("portfolioIDField is a required property for CreatePortfolioResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for CreatePortfolioResponse and cannot be null");
            }
            else
            {
