...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetPrepperTemplateRequest :  IEquatable<GetPrepperTemplateRequest>, IValidatableObject
    {
        ...
        public GetPrepperTemplateRequest(decimal docIDField = default(decimal), decimal prepperTemplateIDField = default(decimal), TokenField tokenField = default(TokenField))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for GetPrepperTemplateRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("prepperTemplateIDField is a required property for GetPrepperTemplateRequest and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for GetPrepperTemplateRequest and cannot be null");
            }
            else
            {
