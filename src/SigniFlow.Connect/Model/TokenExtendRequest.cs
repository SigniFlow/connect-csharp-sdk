...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class TokenExtendRequest :  IEquatable<TokenExtendRequest>, IValidatableObject
    {
        ...
        public TokenExtendRequest(TokenField tokenField = default(TokenField), decimal tokenValidityField = default(decimal))
        {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for TokenExtendRequest and cannot be null");
            }
            else
            {
            ...
            // to ensure "tokenValidityField" is required (not null)
            if (tokenValidityField == null)
            {
                throw new InvalidDataException("tokenValidityField is a required property for TokenExtendRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="TokenValidityField", EmitDefaultValue=true)]        public decimal TokenValidityField { get; set; }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TokenValidityField != null)
