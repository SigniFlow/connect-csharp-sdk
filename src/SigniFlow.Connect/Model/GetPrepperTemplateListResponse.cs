...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetPrepperTemplateListResponse :  IEquatable<GetPrepperTemplateListResponse>, IValidatableObject
    {
        ...
        public GetPrepperTemplateListResponse(string resultField = default(string), List<GetPrepperTemplateListResponseTemplateInformationValuesField> templateInformationValuesField = default(List<GetPrepperTemplateListResponseTemplateInformationValuesField>))
        {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for GetPrepperTemplateListResponse and cannot be null");
            }
            else
            {
            ...
            if (templateInformationValuesField == null)
            {
                throw new InvalidDataException("templateInformationValuesField is a required property for GetPrepperTemplateListResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="TemplateInformationValuesField", EmitDefaultValue=true)]        public List<GetPrepperTemplateListResponseTemplateInformationValuesField> TemplateInformationValuesField { get; set; }
