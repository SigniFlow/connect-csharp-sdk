...
//    
        ...
        public DocPrepperAddAdvancedFieldsRequestFieldOptionsListField(string linkedValueField = default(string), decimal maxField = default(decimal), decimal minField = default(decimal), string valueField = default(string))
        {
            ...
            this.LinkedValueField = linkedValueField ?? throw new ArgumentNullException("linkedValueField is a required property for DocPrepperAddAdvancedFieldsRequestFieldOptionsListField and cannot be null");
            this.MaxField = maxField;
            this.MinField = minField;
            // to ensure "valueField" is required (not null)
            this.ValueField = valueField ?? throw new ArgumentNullException("valueField is a required property for DocPrepperAddAdvancedFieldsRequestFieldOptionsListField and cannot be null");
        }
