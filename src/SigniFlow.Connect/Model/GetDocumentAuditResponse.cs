...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class GetDocumentAuditResponse : IEquatable<GetDocumentAuditResponse>, IValidatableObject
    {
        ...
        public GetDocumentAuditResponse(List<GetDocumentAuditResponseActivityField> activityField = default(List<GetDocumentAuditResponseActivityField>), string resultField = default(string))
        {
            ...
            this.ActivityField = activityField ?? throw new ArgumentNullException("activityField is a required property for GetDocumentAuditResponse and cannot be null");
            // to ensure "resultField" is required (not null)
            this.ResultField = resultField ?? throw new ArgumentNullException("resultField is a required property for GetDocumentAuditResponse and cannot be null");
        }
