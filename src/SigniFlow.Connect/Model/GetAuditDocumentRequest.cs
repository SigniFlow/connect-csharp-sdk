...
namespace SigniFlow.Connect.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetAuditDocumentRequest :  IEquatable<GetAuditDocumentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAuditDocumentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetAuditDocumentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAuditDocumentRequest" /> class.
        /// </summary>
        ...
        public GetAuditDocumentRequest(string docIDField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for GetAuditDocumentRequest and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for GetAuditDocumentRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetAuditDocumentRequest);
        }

        /// <summary>
        /// Returns true if GetAuditDocumentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAuditDocumentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAuditDocumentRequest input)
        {
            if (input == null)
                return false;
