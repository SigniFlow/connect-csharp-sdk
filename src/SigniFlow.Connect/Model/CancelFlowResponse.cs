...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class CancelFlowResponse :  IEquatable<CancelFlowResponse>, IValidatableObject
    {
        ...
        public CancelFlowResponse(decimal docIDField = default(decimal), string resultField = default(string))
        {
            // to ensure "docIDField" is required (not null)
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for CancelFlowResponse and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for CancelFlowResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CancelFlowResponse);
        }

        /// <summary>
        /// Returns true if CancelFlowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CancelFlowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CancelFlowResponse input)
        {
            if (input == null)
                return false;
