...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class SigningCeremonyV2Response :  IEquatable<SigningCeremonyV2Response>, IValidatableObject
    {
        ...
        public SigningCeremonyV2Response(decimal ceremonyIDField = default(decimal), string resultField = default(string), string signedDocumentField = default(string))
        {
            ...
            {
                throw new InvalidDataException("ceremonyIDField is a required property for SigningCeremonyV2Response and cannot be null");
            }
            else
            {
            ...
            if (resultField == null)
            {
                throw new InvalidDataException("resultField is a required property for SigningCeremonyV2Response and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("signedDocumentField is a required property for SigningCeremonyV2Response and cannot be null");
            }
            else
            {
