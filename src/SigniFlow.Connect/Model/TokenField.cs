...
//    
        ...
        public TokenField(DateTime tokenExpiryField = default(DateTime), string tokenField = default(string))
        {
            ...
            this._TokenField = tokenField ?? throw new ArgumentNullException("tokenField is a required property for TokenField and cannot be null");
        }
        ...
        [DataMember(Name = "TokenExpiryField", IsRequired = true, EmitDefaultValue = true)]
