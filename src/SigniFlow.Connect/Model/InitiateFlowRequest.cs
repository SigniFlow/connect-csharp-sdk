...
namespace SigniFlow.Connect.Model
{
    ...
    public partial class InitiateFlowRequest :  IEquatable<InitiateFlowRequest>, IValidatableObject
    {
        ...
        public InitiateFlowRequest(string docIDField = default(string), TokenField tokenField = default(TokenField))
        {
            ...
            if (docIDField == null)
            {
                throw new InvalidDataException("docIDField is a required property for InitiateFlowRequest and cannot be null");
            }
            else
            {
            ...
            if (tokenField == null)
            {
                throw new InvalidDataException("tokenField is a required property for InitiateFlowRequest and cannot be null");
            }
            else
            {
