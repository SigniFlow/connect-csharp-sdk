...
namespace SigniFlow.Connect.Api
{
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <summary>
        /// Create Portfolio #### The API call used to group documents by creating a portfolio to store them in.
        /// </summary>
        /// <exception cref="SigniFlow.Connect.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contentType"></param>
        /// <param name="createPortfolioRequest">##### Create Portfolio Request Model (optional)</param>
        ...
        /// <summary>
        /// Download Portfolio #### The API call used to return a string that is then used to download a portfolio.
        /// </summary>
        /// <exception cref="SigniFlow.Connect.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contentType"></param>
        /// <param name="downloadPortfolioRequest">##### Download Portfolio Request Model (optional)</param>
        ...
        /// <summary>
        /// Link To Portfolio #### Used to get the url link to a portfolio in order to link a document to a portfolio.
        /// </summary>
        /// <exception cref="SigniFlow.Connect.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contentType"></param>
        /// <param name="linkToPortfolioRequest">##### Link To Portfolio Request Model (optional)</param>
        ...
        /// <summary>
        /// Share Portfolio #### Used when a user wants to share a portfolio with someone else.  Enumerations used in this API Call include: | Enumeration    | Values          | | - -- -- -- -- -- -- - |:- -- -- -- -- -- -- --:| | **AccessLevelField** | 0 &#x3D; Viewer *(User has access to view documents in the portfolio)*, 1 &#x3D; Contributor *(User can upload documents to placeholders)*, 2 &#x3D; Owner *(User has full control over the portfolio)* | | **ShareOptionField** | 0 &#x3D; Business *(Share with an entire business)*, 1 &#x3D; Department *(Share with a specific department)*, 2 &#x3D; Team *(Share with a specific team)*, 3 &#x3D; User *(Share with a specific user)* |
        /// </summary>
        /// <exception cref="SigniFlow.Connect.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contentType"></param>
        /// <param name="sharePortfolioRequest">##### Share Portfolio Request Model (optional)</param>
        ...
        /// <summary>
        /// Share Portfolio No Email #### Used when a user wants to share a portfolio without sending out an email.  Enumerations used in this API Call include: | Enumeration    | Values          | | - -- -- -- -- -- -- - |:- -- -- -- -- -- -- --:| | **AccessLevelField** | 0 &#x3D; Viewer *(User has access to view documents in the portfolio)*, 1 &#x3D; Contributor *(User can upload documents to placeholders)*, 2 &#x3D; Owner *(User has full control over the portfolio)* | | **ShareOptionField** | 0 &#x3D; Business *(Share with an entire business)*, 1 &#x3D; Department *(Share with a specific department)*, 2 &#x3D; Team *(Share with a specific team)*, 3 &#x3D; User *(Share with a specific user)* |
        /// </summary>
        /// <exception cref="SigniFlow.Connect.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="contentType"></param>
        /// <param name="sharePortfolioNoEmailRequest">##### Share Portfolio No Email Request Model (optional)</param>
